...
class _CategorySectionState extends State<_CategorySection> {
  ...
  final List<Map<String, dynamic>> _categories = [
    ...
    {'icon': Icons.science_outlined, 'label': 'Research'},
    {'icon': Icons.build_outlined, 'label': 'Projects'},
    {'icon': Icons.school_outlined, 'label': 'Education'},
    {'icon': Icons.video_library_outlined, 'label': 'Tutorials'},
  ];

  @override
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      animation: widget.welcomeController,
      builder: (context, child) {
        final value = CurvedAnimation(
          parent: widget.welcomeController,
